...
summary(getVector(tree_data, Habito))
...
disp_er <- readRDS("dispersal_Mk/output/disp_er.rds")
...
saveRDS(disp_simp_ard, "output/disp_simp_ard.rds")
...
#disp_simp_er <- readRDS("dispersal_Mk/output/disp_simp_er.rds")
disp_simp_ard <- readRDS("dispersal_Mk/output/disp_simp_ard.rds")
#disp_simp_sym <- readRDS("dispersal_Mk/output/disp_simp_sym.rds")
